...
//    virtual CmdMap* getPopupFunctions(const Vec2i& loc,
//            DynArray<int, 5>* enab) = 0;
...
//    virtual void runCan() = 0;
    ...
    void setPropMode(int s)
    {
        _propMode = s;
    }

    void shiftChanged(const bool in)
    {
        _shift = in;
    }
    void controlChanged(const bool in)
    {
        _control = in;
    }
