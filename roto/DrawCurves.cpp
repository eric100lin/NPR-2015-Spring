...
void DrawCurves::MoveToTop(DrawPath* dp)
{
    _paths.MoveToTail(dp);
}
void DrawCurves::MoveToBottom(DrawPath* dp)
{
    _paths.MoveToHead(dp);
}

void DrawCurves::MoveOneUp(DrawPath* dp)
{
    _paths.MoveOneUp(dp);
}
void DrawCurves::MoveOneDown(DrawPath* dp)
{
    _paths.MoveOneDown(dp);
}
