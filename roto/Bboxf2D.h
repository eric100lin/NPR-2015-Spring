...
public:
    ...
    {
        lower.Set(MIN(a.lower.x(), b.lower.x()), MIN(a.lower.y(), b.lower.y()));
        upper.Set(MAX(a.upper.x(), b.upper.x()), MAX(a.upper.y(), b.upper.y()));
    }

    void setToUnion(Bboxf2D& b)
    {
        lower.Set(MIN(lower.x(), b.lower.x()), MIN(lower.y(), b.lower.y()));
        upper.Set(MAX(upper.x(), b.upper.x()), MAX(upper.y(), b.upper.y()));
    }
