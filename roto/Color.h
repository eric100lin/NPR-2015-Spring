...
{
    return (GLuint(red) << ((3 - RED_OFFSET) * 8))
...
inline void RGB_To_HSV(GLubyte red, GLubyte green, GLubyte blue, float *h,
        float *s, float *v)
{
    float r = red / 255.0;
    float g = green / 255.0;
...
inline void HSV_To_RGB(GLubyte * red, GLubyte * green, GLubyte * blue, float h,
        float s, float v)
{
    if (s == 0)
    {
