...
struct SubRcd
{
    ...
    void set(const double k, const int P)
    {
        _k = k;
        _P = P;
    }
...
public:
    ...
    {
        return _numVar;
    }  // this is subsampled, full 2, coordinate system
    int numVarOneBlock() const
    {
        return _block_size;
    } // subsampled, full 2, one frame
    int origNVOneBlock() const
    {
        return _o_bs;
    } // full 2, one frame
    ...
    void take2(int b, int ib, const double* g1, const double* g2, double res,
            const double c);
    ...
    void take4(int b, int ib, const double* g1, const double* g2, double res,
            const double c);
    ...
    void take6(int b, int ib, const double* g1, const double* g2, double res,
            const double c);
    ...
    void _take2(const int b, const int ib, const double* g1, const double* g2,
    ...
    void _take4(const int b, const int ib, const double* g1, const double* g2,
            double res, const double c);
    void _take4Key1(const int ib, const double* g1, double res, const double c);

    void _take6Key0(const int ib, const double* g2, const double res,
            const double c);
    void _take6(const int b, const int ib, const double* g1, const double* g2,
            double res, const double c);
    void _take6Key1(const int ib, const double* g1, double res, const double c);

    void _takejKey0(int j, const int ib, const double* g2, double res,
            const double c);
    void _takej(int j, const int b, const int ib, const double* g1,
            const double* g2, double res, const double c);
    void _takejKey1(int j, const int ib, const double* g1, double res,
            const double c);

    void _takejKeyb(const int b, int j, const int ib, const double* g1,
            double res, const double c);

    void _take2Keyb(const int b, const int ib, const double* g1, double res,
            const double c);
    void _take4Keyb(const int b, const int ib, const double* g1, double res,
            const double c);

    int convert1(int ib, const int hm, int& nib, const double* g1, double* G1);
    int convert2(int ib, const int hm, int& nib, const double* g1,
