...
public:
    ...
    friend void Vec2i_WeightedSum(Vec2i &a, const Vec2i &b, int c,
            const Vec2i &d, int e)
    {
    ...
    float distanceTo(const Vec2i& P) const
    {
        return sqrt(
                float(
                        (P._data[0] - _data[0]) * (P._data[0] - _data[0])
                                + (P._data[1] - _data[1])
                                        * (P._data[1] - _data[1])));
    }
...
public:
    ...
    friend void Vec3i_WeightedSum(Vec3i &a, const Vec3i &b, int c,
            const Vec3i &d, int e)
    {
        a._data[0] = b._data[0] * c + d._data[0] * e;
        a._data[1] = b._data[1] * c + d._data[1] * e;
    ...
    {
        if (_data[0] < min_max[0][0])
            min_max[0][0] = _data[0];
        else if (_data[0] > min_max[1][0])
            min_max[1][0] = _data[0];
        if (_data[1] < min_max[0][1])
            min_max[0][1] = _data[1];
        else if (_data[1] > min_max[1][1])
            min_max[1][1] = _data[1];
        if (_data[2] < min_max[0][2])
            min_max[0][2] = _data[2];
        else if (_data[2] > min_max[1][2])
            min_max[1][2] = _data[2];
    }
...
public:
    ...
    friend void Vec4i_WeightedSum(Vec4i &a, const Vec4i &b, int c,
            const Vec4i &d, int e)
    {
        a._data[0] = b._data[0] * c + d._data[0] * e;
        a._data[1] = b._data[1] * c + d._data[1] * e;
...
public:
    ...
    friend void Vec2f_AddScale(Vec2f &a, const Vec2f &b, const Vec2f &c,
            float d)
    {
        a._data[0] = b._data[0] + c._data[0] * d;
        a._data[1] = b._data[1] + c._data[1] * d;
    ...
    friend void Vec2f_WeightedSum(Vec2f &a, const Vec2f &b, float c,
            const Vec2f &d, float e)
    {
        a._data[0] = b._data[0] * c + d._data[0] * e;
        a._data[1] = b._data[1] * c + d._data[1] * e;
    }

    friend void Vec2f_LinInterp(Vec2f &a, const Vec2f &b, const Vec2f &c,
            float t)
    {
    ...
    float Len() const
    {
        float l = sqrt(_data[0] * _data[0] + _data[1] * _data[1]);
        return l;
    }
...
public:
    ...
    friend void Vec3f_AddScale(Vec3f &a, const Vec3f &b, const Vec3f &c,
            float d)
    {
        a._data[0] = b._data[0] + c._data[0] * d;
        a._data[1] = b._data[1] + c._data[1] * d;
    ...
    friend void Vec3f_WeightedSum(Vec3f &a, const Vec3f &b, float c,
            const Vec3f &d, float e)
    {
        a._data[0] = b._data[0] * c + d._data[0] * e;
        a._data[1] = b._data[1] * c + d._data[1] * e;
        a._data[2] = b._data[2] * c + d._data[2] * e;
    ...
    {
        float l = sqrt(
                _data[0] * _data[0] + _data[1] * _data[1]
                        + _data[2] * _data[2]);
        return l;
    }
...
public:
    ...
    friend void Vec4f_AddScale(Vec4f &a, const Vec4f &b, const Vec4f &c,
            float d)
    {
        a._data[0] = b._data[0] + c._data[0] * d;
        a._data[1] = b._data[1] + c._data[1] * d;
    ...
    friend void Vec4f_WeightedSum(Vec4f &a, const Vec4f &b, float c,
            const Vec4f &d, float e)
    {
        a._data[0] = b._data[0] * c + d._data[0] * e;
        a._data[1] = b._data[1] * c + d._data[1] * e;
        a._data[2] = b._data[2] * c + d._data[2] * e;
